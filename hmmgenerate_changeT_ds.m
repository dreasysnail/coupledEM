function [seq,  states]= hmmgenerate_changeT_ds(L,tr,e,T)
%L of T
...
%ZYZ Need also to check it is a prob
checkT = length(T);
if checkT ~= L
    error(message('Transition variable is not Len long!'));
end
%ZYZEND
